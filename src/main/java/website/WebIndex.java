...
public class WebIndex extends WebHtml {
    ...
    public WebIndex() {
        ...
        html = "<!DOCTYPE html>\n" +
                ...
                "          Our goal is to provide researchers with a tool to streamline their research, minimise wasteful use of their time and funding, all the while minimising animal testing!\n" +
                "        </p>\n" +
                "      </div>\n" +
                "      <div class=\"row px-2\">\n" +
                "        <p align=\"justify\"><strong>How to use the page</strong><br>\n" +
                "          Use the search bar to search for literature (for example from a particular author, or from publications from a specific year!) You can also leave it empty to display all the available papers! <br>\n" +
